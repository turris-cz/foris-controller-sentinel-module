...
from foris_controller_sentinel_module import __version__

DESCRIPTION = """
Sentinel module for Foris Controller
"""

setup(
    name="foris-controller-sentinel-module",
    version=__version__,
    author="CZ.NIC, z.s.p.o. (http://www.nic.cz/)",
    author_email="packaging@turris.cz",
    packages=[
        "foris_controller_sentinel_module",
        "foris_controller_backends",
        "foris_controller_backends.sentinel",
        "foris_controller_modules",
        "foris_controller_modules.sentinel",
        "foris_controller_modules.sentinel.handlers",
    ],
    package_data={"foris_controller_modules.sentinel": ["schema", "schema/*.json"]},
